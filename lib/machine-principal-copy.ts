...
const english = {
  ...
  rotateConfirm: "Rotate this credential?",
  overlapNotice: "After rotation, the old credential stays active until you explicitly revoke it. Both credentials remain actionable.",
...
const chinese = {
  ...
  rotateConfirm: "轮换此凭证？",
  overlapNotice: "轮换后，旧凭证会保持有效，直到您明确撤销它。两条凭证记录都可继续操作。",
