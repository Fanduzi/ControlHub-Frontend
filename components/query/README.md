...
| query-editor-shell.tsx | Tabbed editor shell with server-authorized CSV export, serialized owner workspace hydration/OCC persistence, unavailable-target retargeting, bounded worksheet creation, and new-tab history restore |
...
| query-history-panel.tsx | Query execution history panel with owner-success-only statement restore affordance |
