...
function groupTargetsByEnvironmentAndCluster(targets: QueryTarget[]): TargetGroup[] {
...
function TargetSwitcher({
  ...
  const groupedTargets = useMemo(
    () => groupTargetsByEnvironmentAndCluster(sortedTargets),
    [sortedTargets],
  );
  ...
  return (
    ...
    >
              ...
              >
                ...
                <CommandList>
                  ...
                  {groupedTargets.map((group) => (
                    <CommandGroup key={group.environment} heading={group.environment}>
      ...
      {/* Active target heading and compact target summary chips */}
      {activeTarget && (
