...
| `resources.test.ts` | Resource request paths, selected-environment pagination and member signals, managed-identity create payloads, server-derived completeness write exclusion, and effective-value override payloads |
