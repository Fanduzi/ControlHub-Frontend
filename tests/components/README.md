...
| query-editor-shell.test.tsx | QueryEditorShell — tabs, template mode, lifecycle, serialized workspace OCC/hydration, unavailable-target locking, worksheet limits, execution routing, server-authorized history restore, and blocked-result redaction |
