...
|------|---------------------|
| query-saved-statements.test.tsx | QuerySavedStatements — terminal list generations, CRUD, shared-template gate, templates |
...
| edit-resource-sheet.test.tsx | Edit resource sheet |
