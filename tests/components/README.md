...
| resource-table.test.tsx | Resource table, including settings-backed lifecycle and health taxonomies, completeness and health evidence fields, and reviewed admin bulk-label mutations |
